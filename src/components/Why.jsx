            ...
            <div className="py-8 md:py-16 w-full md:w-11/12 lg:w-10/12 xl:w-1200 m-auto">
                <div className="space-y-8 md:space-y-0 md:flex md:items-center md:justify-center md:space-x-16">
                    <div className="w-full md:w-2/4 space-y-4 md:text-left">
                        ...
                        <p className="text-[#006A66] font-lato text-lg text-center md:text-left">
                    ...
                    <div className="mx-auto w-full md:w-/4 flex justify-center">
                        <img src={Why1} alt="why1" className="w-2/4 md:w-full" />
                        <img src={Why2} alt="why2" className="w-2/4 md:w-full" />
                    </div>
                </div>
            </div>
        </div>
